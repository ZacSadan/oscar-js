...
export const STRINGS = {
  en: {
    ...
    sleepRestorative: 'Restorative sleep',
    sleepAsleep: 'Asleep:',
    sleepCompareCaveat: 'Read this as a prompt, not a result. Only nights the machine actually ran are shown, and the grey bar is the part of such a night spent asleep after the mask came off — so both halves come from the same night. That removes a lot of noise, but not all of it: the mask usually comes off late in the night, when sleep is naturally more REM-heavy anyway. A difference here is worth asking about, not a measurement of what therapy did.',
    ...
    gSleepBack: 'Total sleep your watch recorded that night, drawn beside the therapy bar on the same hours axis. A grey bar taller than the green one means you slept longer than the machine ran.',
    gSleepRestorative: 'Deep and REM sleep added together, as a percentage of the sleep you actually got that night. Dividing by sleep rather than by time in bed keeps a restless night from being counted against you twice.',
  ...
  he: {
    ...
    sleepRestorative: 'שינה משקמת',
    sleepAsleep: 'זמן שינה:',
    sleepCompareCaveat: 'יש לקרוא זאת כנקודה לבדיקה ולא כתוצאה. מוצגים רק לילות שבהם המכשיר אכן פעל, והעמודה האפורה היא החלק מאותו לילה שעבר בשינה לאחר שהמסכה הוסרה — כך ששני החלקים מגיעים מאותו לילה. זה מסלק הרבה רעש, אך לא את כולו: המסכה מוסרת בדרך כלל בשלב מאוחר של הלילה, כשהשינה עשירה יותר ב‎REM ממילא. הבדל כאן שווה שאלה, אך אינו מדידה של מה שהטיפול עשה.',
    ...
    gSleepBack: 'סך השינה שהשעון רשם באותו לילה, מצויר לצד עמודת הטיפול על אותו ציר שעות. עמודה אפורה גבוהה מהירוקה מעידה שישנת יותר זמן ממה שהמכשיר פעל.',
    gSleepRestorative: 'שינה עמוקה ו‎REM יחד, כאחוז מהשינה שאכן הייתה באותו לילה. חלוקה בשינה ולא בזמן במיטה מונעת מלילה חסר מנוחה להיספר לרעה פעמיים.',
